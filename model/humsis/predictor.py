...
from humsis.model_tools.resnet50 import ResNet
from humsis.model_tools.yolo_detector import Detector
from humsis.structures import AGE_GENDER_TYPE, PersonAndFaceResult
...
class Predictor:
    ...
    def recognize(self, image: np.ndarray) -> Tuple[PersonAndFaceResult, Optional[np.ndarray]]:
        ...
        self.emotion_model.predict(image, detected_objects)
    ...
    def recognize_video(self, source: str) -> Generator:
        ...
        detected_objects_history: Dict[int,
                                       List[AGE_GENDER_TYPE]] = defaultdict(list)
